(function(){function c(a){a=a||{};this.channels=new c.Channels(a);this.params=a.params;this.ready=!1;this.buffer=[];var b=this;b.debug=a.debug?a.debug:!1;var e=new ReconnectingWebSocket("ws://"+((a.endpoint?a.endpoint:"localhost:9000")+"/socket"));e.onopen=function(a){if(b.debug){var d={};d.type=a.type;d.timestamp=a.timeStamp;b.ready=!0;console.log("[warp] open: "+JSON.stringify(d));b._sendBuffer()}};e.onclose=function(a){if(b.debug){var d={};d.type=a.type;d.timestamp=a.timeStamp;console.log("[warp]: "+
