...
100)});a.buffer=[]};a._send=function(c,b){var d={};d.channel=c;d.timestamp=Date.now();this.params&&(d.params=this.params);d.msg=b;a.ready?a._sendJSON(d):a.buffer.push(d)};a._subscribe=function(b,d){var e={};e.subscribe=b;d&&(e.data=d);a._sendJSON(e)};a._close=function(){a.ws.close(1E3)}}d.prototype.subscribe=function(b,a,c){this.channel.add(b,a,c);this.ws.readyState?this._subscribe(b,c):(a={},a.subscribe=b,c&&(a.data=c),this.buffer.push(a))};d.prototype.unsubscribe=function(b){this.channel.remove(b)};
d.prototype.beam=function(b,a){this._send(b,a)};d.prototype.allChannels=function(){return this.channel.all()};d.prototype.close=function(){this._close()};this.Warp=d}).call(this);
